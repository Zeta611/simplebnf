...
\begin{tcolorbox}[sharp corners]
  \begin{center}
    \begin{bnf}(
      ...
      ! \texttt{\metabnfcomment\char`{$c$\char`}} // comment-only row
      ! \texttt{\metabnfcomment\char`{$c$\char`}\,$P$} // comment row + production
    ;;;
...
\subsection{Comment-only rows}\label{subsec:comment}
To insert a non-production row (e.g., a section header or a comment) inside a grammar, use \cmd{bnfcomment}:
\begin{example}
\begin{center}
\begin{bnf}
  \bnfcomment{Types}
