...
\title{%
  ...
  \footnote{This file describes v1.0.1.}}
...
\subsection*{Comment-only rows}
Any row without a rule relation is typeset as a full-width comment row.
For readability, \textsf{simplebnf} also provides \cmd{bnfcomment}, which simply expands to its argument and can be used to make such rows explicit:
\begin{example}*
\begin{center}
\begin{bnf}
  \bnfcomment{Types}
